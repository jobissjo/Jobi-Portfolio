...
export class AboutComponent {
  abouts: string[] = [
    ...
    I'm skilled in Django, FastAPI, SQL, and MongoDB, and also know Docker, Git, and cloud deployment.`,

    `I'm always learning about machine learning, microservices, and cloud technologies. 
